...
class SectionPool implements SectionPoolInterface
{
    ...
    /**
     * @var \Magento\Seller\SellerData\Section\Identifier
     */
     ...
     * @param \Magento\Seller\SellerData\Section\Identifier $identifier
     * @param array $sectionSourceMap
     */
    public function __construct(
        ObjectManagerInterface $objectManager,
        \Magento\Seller\SellerData\Section\Identifier $identifier,
    ...
    protected function get($name)
    {
        ...
        if (!$sectionSource instanceof SectionSourceInterface) {
            throw new LocalizedException(
                __('%1 doesn\'t extend \Magento\Seller\SellerData\SectionSourceInterface', $name)
            );
        }
