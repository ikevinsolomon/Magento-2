...
class Address extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const XML_PATH_VIV_DISABLE_AUTO_ASSIGN_DEFAULT = 'seller/create_account/viv_disable_auto_group_assign_default';

    const XML_PATH_VIV_ON_EACH_TRANSACTION = 'seller/create_account/viv_on_each_transaction';

    const XML_PATH_VAT_VALIDATION_ENABLED = 'seller/create_account/auto_group_assign';

    const XML_PATH_VIV_TAX_CALCULATION_ADDRESS_TYPE = 'seller/create_account/tax_calculation_address_type';

    const XML_PATH_VAT_FRONTEND_VISIBILITY = 'seller/create_account/vat_frontend_visibility';

    /**
     * Possible seller address types
     */
    ...
    /**
     * Array of Seller Address Attributes
     *
    ...
    /**
     * Seller address config node per website
     *
     * @var array
     */
    protected $_config = [];
    ...
    /**
     * Seller Number of Lines in a Street Address per website
     *
     * @var array
     */
    ...
    /**
     * Return seller address config value by key and store
     *
     * @param string $key
     ...
     *
     * @param string $code
     * @return \Magento\Seller\Block\Address\Renderer\RendererInterface|null
     */
    ...
    /**
     * Retrieve seller address type on which tax calculation must be based
     *
    ...
    /**
     * Check if VAT ID address attribute has to be shown on frontend (on Seller Address management forms)
     *
     * @return boolean
     */
