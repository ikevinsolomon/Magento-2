...
class LoginPost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
     ...
     * @param SellerUrl $sellerHelperData
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    $seller = $this->sellerAccountManagement->authenticate($login['username'], $login['password']);
                    ...
                    if (!$this->getScopeConfig()->getValue('seller/startup/redirect_dashboard') && $redirectUrl) {
                    ...
                    $this->messageManager->addComplexErrorMessage(
                        ...
                        ['url' => $this->sellerUrl->getEmailConfirmationUrl($login['username'])]
                    );
                    ...
                    // PA DSS violation: throwing or logging an exception here can disclose seller password
