...
namespace Magento\Seller\Controller\Adminhtml\Cart\Product\Composite;
...
abstract class Cart extends \Magento\Backend\App\Action
{
    ...
    /**
     * Seller we're working with
     *
     * @var int id of the seller
     */
    protected $_sellerId;
    ...
    /**
     * Loads seller, quote and quote item by request params
     *
     * @return $this
    ...
    {
        $this->_sellerId = (int)$this->getRequest()->getParam('seller_id');
        if (!$this->_sellerId) {
            throw new \Magento\Framework\Exception\LocalizedException(__("The seller ID isn't defined."));
        }
        ...
        try {
            $this->_quote = $this->quoteRepository->getForSeller($this->_sellerId);
