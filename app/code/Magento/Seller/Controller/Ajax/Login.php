...
class Login extends \Magento\Framework\App\Action\Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            $seller = $this->sellerAccountManagement->authenticate(
                $credentials['username'],
                $credentials['password']
            );
            $this->sellerSession->setSellerDataAsLoggedIn($seller);
            ...
            if (!$this->getScopeConfig()->getValue('seller/startup/redirect_dashboard') && $redirectRoute) {
