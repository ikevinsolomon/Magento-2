...
namespace Magento\Seller\Controller\Address\File;
...
/**
 * Class for upload files for seller custom address attributes
 */
class Upload extends Action implements HttpPostActionInterface
{
    ...
    /**
     * Move file from temporary folder to the 'seller_address' media folder
     *
