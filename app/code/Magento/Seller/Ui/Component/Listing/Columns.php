...
use Magento\Seller\Ui\Component\ColumnFactory;
use Magento\Seller\Api\Data\AttributeMetadataInterface as AttributeMetadata;
use Magento\Framework\View\Element\UiComponentInterface;
use Magento\Seller\Ui\Component\Listing\Column\InlineEditUpdater;
...
class Columns extends \Magento\Ui\Component\Listing\Columns
{
    ...
    /**
     * @var \Magento\Seller\Ui\Component\Listing\AttributeRepository
     */
    protected $attributeRepository;

    /**
     * @var \Magento\Seller\Ui\Component\Listing\Column\InlineEditUpdater
     */
    ...
    public function updateColumn(array $attributeData, $newAttributeCode)
    {
        ...
        if ($attributeData[AttributeMetadata::BACKEND_TYPE] != 'static') {
            ...
            if ($attributeData['entity_type_code'] == SellerMetadataInterface::ENTITY_TYPE_SELLER
