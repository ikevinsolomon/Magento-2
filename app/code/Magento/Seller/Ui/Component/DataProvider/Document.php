 ...
 */
namespace Magento\Seller\Ui\Component\DataProvider;
...
class Document extends \Magento\Framework\View\Element\UiComponent\DataProvider\Document
{
    ...
    /**
     * Update seller gender value. Method set gender label instead of id value
     *
     * @return void
    ...
    private function setGenderValue()
    {
        ...
        try {
            $attributeMetadata = $this->sellerMetadata->getAttributeMetadata(self::$genderAttributeCode);
    ...
    /**
     * Update seller group value. Method set group code instead id value
     *
     * @return void
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    private function setSellerGroupValue()
    {
