...
/**
 * Replaces a "%seller_group_id%" value with the real seller id
 */
class ParamOverriderSellerGroupId implements ParamOverriderInterface
{
    /**
    ...
    public function getOverriddenValue()
    {
        if ((int) $this->userContext->getUserType() === UserContextInterface::USER_TYPE_SELLER) {
            return $this->sellerRepository->getById($this->userContext->getUserId())->getGroupId();
        }
