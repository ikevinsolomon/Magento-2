...
/**
 * Replaces a "%seller_store_id%" value with the real seller id
 */
class ParamOverriderSellerStoreId implements ParamOverriderInterface
{
    /**
    ...
    public function getOverriddenValue()
    {
        if ((int) $this->userContext->getUserType() === UserContextInterface::USER_TYPE_SELLER) {
            return $this->sellerRepository->getById($this->userContext->getUserId())->getStoreId();
        }
