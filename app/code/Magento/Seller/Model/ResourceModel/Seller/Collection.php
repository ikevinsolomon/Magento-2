...
class Collection extends \Magento\Eav\Model\Entity\Collection\VersionControl\AbstractCollection
{
     ...
     */
    const SELLER_MODEL_NAME = \Magento\Seller\Model\Seller::class;
    ...
    public function __construct(
        ...
        $modelName = self::SELLER_MODEL_NAME
    ) {
    ...
    {
        $this->_init($this->_modelName, \Magento\Seller\Model\ResourceModel\Seller::class);
    }

    /**
     * Group result by seller email
     *
     * @return $this
     */
    ...
    {
        $fields = [];
        $sellerAccount = $this->_fieldsetConfig->getFieldset('seller_account');
        foreach ($sellerAccount as $code => $field) {
            if (isset($field['name'])) {
                $fields[$code] = $code;
            }
        }
