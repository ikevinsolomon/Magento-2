...
use Magento\Seller\Model\ResourceModel\Group\Collection;
...
use Magento\Seller\Api\Data\GroupExtensionInterface;

/**
 * Seller group CRUD class
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class GroupRepository implements \Magento\Seller\Api\GroupRepositoryInterface
{
    /**
    ...
    /**
     * @var \Magento\Seller\Model\GroupRegistry
     */
    protected $groupRegistry;

    /**
     * @var \Magento\Seller\Model\GroupFactory
     */
    ...
    /**
     * @var \Magento\Seller\Model\ResourceModel\Group
     */
    ...
    /**
     * @var \Magento\Seller\Api\Data\GroupSearchResultsInterfaceFactory
     */
    ...
    /**
     * @param \Magento\Seller\Model\GroupRegistry $groupRegistry
     * @param \Magento\Seller\Model\GroupFactory $groupFactory
     * @param \Magento\Seller\Api\Data\GroupInterfaceFactory $groupDataFactory
     * @param \Magento\Seller\Model\ResourceModel\Group $groupResourceModel
     * @param \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor
     * @param \Magento\Seller\Api\Data\GroupSearchResultsInterfaceFactory $searchResultsFactory
     * @param \Magento\Tax\Api\TaxClassRepositoryInterface $taxClassRepositoryInterface
     * @param \Magento\Framework\Api\ExtensionAttribute\JoinProcessorInterface $extensionAttributesJoinProcessor
     * @param CollectionProcessorInterface $collectionProcessor
     */
    public function __construct(
        \Magento\Seller\Model\GroupRegistry $groupRegistry,
        \Magento\Seller\Model\GroupFactory $groupFactory,
        \Magento\Seller\Api\Data\GroupInterfaceFactory $groupDataFactory,
        \Magento\Seller\Model\ResourceModel\Group $groupResourceModel,
        \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor,
        \Magento\Seller\Api\Data\GroupSearchResultsInterfaceFactory $searchResultsFactory,
    ...
    public function save(\Magento\Seller\Api\Data\GroupInterface $group)
    {
        ...
        /** @var \Magento\Seller\Model\Group $groupModel */
        $groupModel = null;
        ...
        try {
             ...
             */
            if ($e->getMessage() == (string)__('Seller Group already exists.')) {
                throw new InvalidTransitionException(__('Seller Group already exists.'));
            }
            throw $e;
        }
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \Magento\Seller\Model\ResourceModel\Group\Collection $collection */
        $collection = $this->groupFactory->create()->getCollection();
        $groupInterfaceName = \Magento\Seller\Api\Data\GroupInterface::class;
        $this->extensionAttributesJoinProcessor->process($collection, $groupInterfaceName);
        $collection->addTaxClass();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \Magento\Seller\Api\Data\GroupInterface[] $groups */
        $groups = [];
        /** @var \Magento\Seller\Model\Group $group */
        foreach ($collection as $group) {
            /** @var \Magento\Seller\Api\Data\GroupInterface $groupDataObject */
            $groupDataObject = $this->groupDataFactory->create()
                ->setId($group->getId())
    ...
    /**
     * Verifies that the tax class model exists and is a seller tax class type.
     *
     * @param int $taxClassId The id of the tax class model to check
     * @param \Magento\Seller\Api\Data\GroupInterface $group The original group parameters
     * @return void
    ...
    protected function _verifyTaxClassModel($taxClassId, $group)
    {
        ...
        if ($taxClassData->getClassType() !== TaxClassManagementInterface::TYPE_SELLER) {
            throw InputException::invalidFieldValue('taxClassId', $group->getTaxClassId());
        }
    }
    ...
    private function getCollectionProcessor()
    {
        if (!$this->collectionProcessor) {
            $this->collectionProcessor = \Magento\Framework\App\ObjectManager::getInstance()->get(
                'Magento\Seller\Model\Api\SearchCriteria\GroupCollectionProcessor'
            );
        }
