...
class Form
{
    ...
    /**
     * @var \Magento\Seller\Api\Data\AttributeMetadataInterface[]
     */
     ...
     *
     * @return \Magento\Seller\Api\Data\AttributeMetadataInterface[]
     * @throws \LogicException For undefined entity type
     */
    public function getAttributes()
    {
        if (!isset($this->_attributes)) {
            if ($this->_entityType === \Magento\Seller\Api\SellerMetadataInterface::ENTITY_TYPE_SELLER) {
                $this->_attributes = $this->_sellerMetadataService->getAttributes($this->_formCode);
            } elseif ($this->_entityType === \Magento\Seller\Api\AddressMetadataInterface::ENTITY_TYPE_ADDRESS) {
     ...
     * @return \Magento\Seller\Api\Data\AttributeMetadataInterface|false
     */
    ...
    protected function _getValidator(array $data)
    {
        ...
        $builder = $validatorFactory->createValidatorBuilder('seller', 'form');
