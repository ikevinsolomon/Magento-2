...
class Image extends File
{
    ...
    protected function processUiComponentValue(array $value)
    {
        if ($this->_entityTypeCode == AddressMetadataInterface::ENTITY_TYPE_ADDRESS) {
            return $this->processSellerAddressValue($value);
        }

        if ($this->_entityTypeCode == SellerMetadataInterface::ENTITY_TYPE_SELLER) {
            return $this->processSellerValue($value);
        }
    ...
    /**
     * Process file uploader UI component data for seller_address entity
     *
     * @param array $value
     * @return string
     * @throws LocalizedException
     */
    protected function processSellerAddressValue(array $value)
    {
    ...
    /**
     * Process file uploader UI component data for seller entity
     *
     * @param array $value
     * @return bool|int|ImageContentInterface|string
     * @throws LocalizedException
     */
    protected function processSellerValue(array $value)
    {
