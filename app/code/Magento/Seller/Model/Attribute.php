...
class Attribute extends \Magento\Eav\Model\Attribute
{
     ...
     * Name of the module
     */
    const MODULE_NAME = 'Magento_Seller';
    ...
    /**
     * @var \Magento\Seller\Model\Metadata\AttributeMetadataCache
     */
     ...
     * @param \Magento\Seller\Model\Metadata\AttributeMetadataCache|null $attributeMetadataCache
    ...
    public function __construct(
        ...
        array $data = [],
        \Magento\Seller\Model\Metadata\AttributeMetadataCache $attributeMetadataCache = null
    ) {
        $this->indexerRegistry = $indexerRegistry;
        $this->attributeMetadataCache = $attributeMetadataCache ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->get(\Magento\Seller\Model\Metadata\AttributeMetadataCache::class);
        parent::__construct(
            $context,
            $registry,
            $extensionFactory,
    ...
    {
        $this->_init(\Magento\Seller\Model\ResourceModel\Attribute::class);
    }
