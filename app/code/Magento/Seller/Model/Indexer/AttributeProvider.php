...
class AttributeProvider implements FieldsetInterface
{
    ...
    private function getAttributes()
    {
        if ($this->attributes === null) {
            ...
            /** @var \Magento\Seller\Model\Attribute[] $attributes */
            $attributes = $entityType->getAttributeCollection()->getItems();
            /** @var \Magento\Seller\Model\ResourceModel\Seller $entity */
            ...
            if (!$attribute->isStatic()) {
                if ($attribute->getData('is_used_in_grid')) {
                    $fields[$attribute->getName()] = [
                        ...
                        'bind' => isset($fieldset['references']['seller']['to'])
                            ? $fieldset['references']['seller']['to']
                            : null,
                    ];
                }
            } else {
