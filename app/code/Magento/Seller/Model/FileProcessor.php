...
class FileProcessor
{
    ...
    private const SELLER_FILE_URL_PATH = 'seller/index/viewfile';

    private const SELLER_ADDRESS_FILE_URL_PATH = 'seller/address/viewfile';
     ...
     * @var string
     */
    private $sellerFileUrlPath;

    /**
     * @var string
     */
    private $sellerAddressFileUrlPath;
     ...
     * @param string $sellerFileUrlPath
     * @param string $sellerAddressFileUrlPath
     */
    public function __construct(
        ...
        string $sellerFileUrlPath = self::SELLER_FILE_URL_PATH,
        string $sellerAddressFileUrlPath = self::SELLER_ADDRESS_FILE_URL_PATH
    ) {
        ...
        $this->sellerFileUrlPath = $sellerFileUrlPath;
        $this->sellerAddressFileUrlPath = $sellerAddressFileUrlPath;
    }
    ...
    /**
     * Retrieve seller/index/viewfile action URL
     *
    ...
    public function getViewUrl($filePath, $type)
    {
        ...
        if ($this->entityTypeCode == AddressMetadataInterface::ENTITY_TYPE_ADDRESS) {
            $viewUrl = $this->urlBuilder->getUrl(
                $this->sellerAddressFileUrlPath,
                [$type => $this->urlEncoder->encode(ltrim($filePath, '/'))]
            );
        }

        if ($this->entityTypeCode == SellerMetadataInterface::ENTITY_TYPE_SELLER) {
            $viewUrl = $this->urlBuilder->getUrl(
                $this->sellerFileUrlPath,
                [$type => $this->urlEncoder->encode(ltrim($filePath, '/'))]
            );
        }
