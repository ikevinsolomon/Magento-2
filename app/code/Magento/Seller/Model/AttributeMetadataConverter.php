...
use Magento\Seller\Api\Data\OptionInterfaceFactory;
use Magento\Seller\Api\Data\ValidationRuleInterfaceFactory;
use Magento\Seller\Api\Data\AttributeMetadataInterfaceFactory;
...
class AttributeMetadataConverter
{
     ...
     * @var string
     */
    private const XML_SELLER_ADDRESS = 'seller/address/';
     ...
     *
     * @param \Magento\Seller\Model\Attribute $attribute
                    ...
                    if (!is_array($option['value'])) {
                        ...
                        foreach ($option['value'] as $optionArrayValues) {
                            ...
                            $this->dataObjectHelper->populateWithArray(
                                $optionObject,
                                $optionArrayValues,
                                \Magento\Seller\Api\Data\OptionInterface::class
                            );
    ...
    {
        $result = [];
        $value = $this->scopeConfig->getValue(self::XML_SELLER_ADDRESS . $attributeCode . '_options');
        if ($value) {
