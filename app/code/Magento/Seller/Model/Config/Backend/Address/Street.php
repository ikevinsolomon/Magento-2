 ...
 */
namespace Magento\Seller\Model\Config\Backend\Address;

use Magento\Framework\App\Config\ScopeConfigInterface;

/**
 * Line count config model for seller address street attribute
 *
...
class Street extends \Magento\Framework\App\Config\Value
{
    ...
    {
        $attribute = $this->_eavConfig->getAttribute('seller_address', 'street');
        $value = $this->getValue();
