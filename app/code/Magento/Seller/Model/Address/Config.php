...
/**
 * Seller address configuration
 */
class Config extends ConfigData
{
    const DEFAULT_ADDRESS_RENDERER = \Magento\Seller\Block\Address\Renderer\DefaultRenderer::class;

    const XML_PATH_ADDRESS_TEMPLATE = 'seller/address_templates/';

    const DEFAULT_ADDRESS_FORMAT = 'oneline';

    /**
     * Seller address templates per store
     *
     * @var array
     */
    protected $_types = [];
    ...
    public function __construct(
        \Magento\Seller\Model\Address\Config\Reader $reader,
