...
class General implements ValidatorInterface
{
    ...
    {
        return $this->eavConfig->getAttribute('seller_address', 'company')->getIsRequired();
    }
    ...
    {
        return $this->eavConfig->getAttribute('seller_address', 'telephone')->getIsRequired();
    }
    ...
    {
        return $this->eavConfig->getAttribute('seller_address', 'fax')->getIsRequired();
    }
