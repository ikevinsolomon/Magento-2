...
/**
 * The class contains methods for getting information about a seller group
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class GroupManagement implements \Magento\Seller\Api\GroupManagementInterface
{
    const XML_PATH_DEFAULT_ID = 'seller/create_account/default_group';
