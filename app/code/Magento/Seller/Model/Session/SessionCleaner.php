...
use Magento\Seller\Model\ResourceModel\Visitor\CollectionFactory as VisitorCollectionFactory;
...
/**
 * Deletes all session data which relates to seller, including current session data.
 *
...
class SessionCleaner implements SessionCleanerInterface
{
    ...
    public function clearFor(int $sellerId): void
    {
        ...
        /** @var \Magento\Seller\Model\ResourceModel\Visitor\Collection $visitorCollection */
        $visitorCollection = $this->visitorCollectionFactory->create();
        $visitorCollection->addFieldToFilter('seller_id', $sellerId);
        ...
        /** @var \Magento\Seller\Model\Visitor $visitor */
