 ...
 *
 * @api
 * @method string getSellerGroupCode()
 * @method \Magento\Seller\Model\Group setSellerGroupCode(string $value)
 * @method \Magento\Seller\Model\Group setTaxClassId(int $value)
...
class Group extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'seller_group';
    ...
    {
        $this->_init(\Magento\Seller\Model\ResourceModel\Group::class);
    }

    /**
     * Alias for setSellerGroupCode
     *
     * @param string $value
     * @return $this
     */
    ...
    {
        return $this->setSellerGroupCode($value);
    }

    /**
     * Alias for getSellerGroupCode
     *
     * @return string
     */
    public function getCode()
    {
        return $this->getSellerGroupCode();
    }
