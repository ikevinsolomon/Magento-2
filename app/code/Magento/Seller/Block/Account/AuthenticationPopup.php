...
class AuthenticationPopup extends \Magento\Framework\View\Element\Template
{
    ...
    public function getConfig()
    {
        return [
            ...
            'sellerRegisterUrl' => $this->escapeUrl($this->getSellerRegisterUrlUrl()),
            'sellerForgotPasswordUrl' => $this->escapeUrl($this->getSellerForgotPasswordUrl()),
    ...
    /**
     * Get seller register url
     *
     * @return string
     */
    public function getSellerRegisterUrlUrl()
    {
        return $this->getUrl('seller/account/create');
    }

    /**
     * Get seller forgot password url
     *
     * @return string
     */
    public function getSellerForgotPasswordUrl()
    {
        return $this->getUrl('seller/account/forgotpassword');
    }
}
