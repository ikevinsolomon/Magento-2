...
/**
 * Class SellerScopeData provide scope (website, store or store_group) information on front
 ...
 * @since 100.1.9
 */
class SellerScopeData extends \Magento\Framework\View\Element\Template
{
    /**
     ...
     *
     * Can be used when necessary to obtain website id of the current seller.
     *
     * @return integer
     * @since 100.1.9
     */
