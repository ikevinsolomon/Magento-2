...
namespace Magento\Seller\Block\Adminhtml\Form\Element\Newsletter;
...
/**
 * Seller Newsletter Subscriptions Element
 */
class Subscriptions extends AbstractElement
{
    ...
    {
        $data = $this->dataPersistor->get('seller_form');
        $currentSellerId = $this->getData('seller_id');
        $sessionSellerId = $data['seller']['entity_id'] ?? null;
        if ($sessionSellerId === null || $currentSellerId !== (int)$sessionSellerId) {
            return null;
        }
