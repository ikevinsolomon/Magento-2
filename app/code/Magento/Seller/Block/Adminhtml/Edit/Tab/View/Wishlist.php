...
/**
 * Adminhtml seller view wishlist block
 *
 * @api
 * @since 100.0.2
 */
class Wishlist extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('seller_view_wishlist_grid');
        $this->setSortable(false);
        $this->setPagerVisibility(false);
        $this->setFilterVisibility(false);
        $this->setEmptyText(__('There are no items in seller\'s shopping cart.'));
    }
    ...
    {
        $collection = $this->_collectionFactory->create()->addSellerIdFilter(
            $this->_coreRegistry->registry(RegistryConstants::CURRENT_SELLER_ID)
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Product'),
                'index' => 'product_name',
                'renderer' => \Magento\Seller\Block\Adminhtml\Edit\Tab\View\Grid\Renderer\Item::class
            ]
        );
