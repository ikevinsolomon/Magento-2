...
/**
 * Generic block that uses seller metatdata attributes.
 *
...
class GenericMetadata extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _setFieldset($attributes, $fieldset, $exclude = [])
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            if (($inputType = $attribute->getFrontendInput()) && !in_array(
                ...
                $this->_applyTypeSpecificConfigSeller($inputType, $element, $attribute);
            }
        }
    }
     ...
     * @return void
     */
    protected function _applyTypeSpecificConfigSeller(
        $inputType,
        $element,
