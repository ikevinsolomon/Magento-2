...
/**
 * Adminhtml seller view sales block
 */
class Sales extends \Magento\Backend\Block\Template
{
    ...
    {
        parent::_construct();
        $this->setId('seller_view_sales_grid');
    }
    ...
    public function _beforeToHtml()
    {
        ...
        $this->_collection = $this->_collectionFactory->create()->setSellerIdFilter(
            (int)$this->_coreRegistry->registry(RegistryConstants::CURRENT_SELLER_ID)
        )->setOrderStateFilter(
