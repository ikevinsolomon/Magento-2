...
use Magento\Seller\Block\Adminhtml\Edit\Tab\View\Grid\Renderer\Item;
use Magento\Seller\Block\Adminhtml\Grid\Renderer\Multiaction;
...
/**
 * Adminhtml seller orders grid block
 *
 * @api
 * @since 100.0.2
...
class Cart extends Extended
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('Magento_Seller::tab/cart.phtml');
    }
    ...
    /**
     * Gets seller assigned to this block
     *
     * @return int
     */
    ...
    {
        return $this->getUrl('seller/*/cart', ['_current' => true, 'website_id' => $this->getWebsiteId()]);
    }
    ...
    protected function getQuote()
    {
        if (null === $this->quote) {
            ...
            try {
                $this->quote = $this->quoteRepository->getForSeller($sellerId, $storeIds);
    ...
    private function prepareWebsiteFilter(): void
    {
        ...
        $formWidget->setTemplate('Magento_Seller::tab/cart_website_filter_form.phtml');
        $this->setChild(
