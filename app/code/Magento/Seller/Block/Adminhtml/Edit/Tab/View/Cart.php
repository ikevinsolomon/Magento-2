...
/**
 * Adminhtml seller cart items grid block
 *
...
class Cart extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('seller_view_cart_grid');
    ...
    protected function getQuote()
    {
        if (null == $this->quote) {
            ...
            $currentSellerId = $this->_coreRegistry->registry(RegistryConstants::CURRENT_SELLER_ID);
            if (!empty($currentSellerId)) {
                try {
                    $this->quote = $this->quoteRepository->getForSeller($currentSellerId, $storeIds);
