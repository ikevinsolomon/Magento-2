 ...
 */
namespace Magento\Seller\Block\Adminhtml\Edit\Tab\Newsletter;

use Magento\Backend\Block\Template\Context;
use Magento\Backend\Block\Widget\Grid\Extended;
use Magento\Backend\Helper\Data;
use Magento\Seller\Block\Adminhtml\Edit\Tab\Newsletter\Grid\Renderer\Action;
use Magento\Seller\Block\Adminhtml\Edit\Tab\Newsletter\Grid\Renderer\Status;
...
class Grid extends Extended
{
    ...
    {
        return $this->getUrl('seller/*/newsletter', ['_current' => true]);
    }
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->_collectionFactory->create()->addTemplateInfo()->addSellerFilter($sellerId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Status'),
                'align' => 'center',
                'filter' => \Magento\Seller\Block\Adminhtml\Edit\Tab\Newsletter\Grid\Filter\Status::class,
                'index' => 'queue_status',
