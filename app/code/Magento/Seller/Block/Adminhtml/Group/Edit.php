 ...
 */
namespace Magento\Seller\Block\Adminhtml\Group;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'label', __('Save Seller Group'));
        $this->buttonList->update('delete', 'label', __('Delete Seller Group'));
    ...
    public function getHeaderText()
    {
        $groupId = $this->coreRegistry->registry(RegistryConstants::CURRENT_GROUP_ID);
        if ($groupId === null) {
            return __('New Seller Group');
        } else {
            $group = $this->groupRepository->getById($groupId);
            return __('Edit Seller Group "%1"', $this->escapeHtml($group->getCode()));
        }
    }
