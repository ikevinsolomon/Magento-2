 ...
 */
namespace Magento\Seller\Block\Adminhtml\System\Config;
...
class Validatevat extends \Magento\Config\Block\System\Config\Form\Field
{
     ...
     * @return \Magento\Seller\Block\Adminhtml\System\Config\Validatevat
     */
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('Magento_Seller::system/config/validatevat.phtml');
        }
        return $this;
    }
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url' => $this->_urlBuilder->getUrl('seller/system_config_validatevat/validate'),
            ]
        );
