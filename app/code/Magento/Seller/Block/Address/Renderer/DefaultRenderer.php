 ...
 */
namespace Magento\Seller\Block\Address\Renderer;

use Magento\Seller\Model\Address\AddressModelInterface;
use Magento\Seller\Model\Address\Mapper;
use Magento\Seller\Model\Metadata\ElementFactory;
    ...
    public function renderArray($addressAttributes, $format = null)
    {
        ...
        foreach ($attributesMetadata as $attributeMetadata) {
            ...
            if ($attributeCode == 'country_id' && isset($addressAttributes['country_id'])) {
                ...
                $dataModel = $this->_elementFactory->create($attributeMetadata, $value, 'seller_address');
