...
class SellerData extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * Get url for seller data ajax requests. Returns url with protocol matching used to request page.
     *
     * @param string $route
     * @return string Seller data url.
     */
    public function getSellerDataUrl($route)
    {
    ...
    {
        return (int)$this->_scopeConfig->getValue('seller/online_sellers/section_data_lifetime');
    }
