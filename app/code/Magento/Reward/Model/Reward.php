...
class Reward extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected function _construct()
    {
        ...
        self::$_actionModelClasses = self::$_actionModelClasses + [
            ...
            self::REWARD_ACTION_CREDITMEMO_VOID => 'Magento\Reward\Model\Action\Creditmemo\Voidcredit',
        ];
    }
     ...
     * @throws \Exception
     */
    public function updateRewardPoints($additionalInfo = NULL)
    {
        ...
        if ($this->canUpdateRewardPoints()) {
            try {
                ...
                $point=$this->getPointsDelta();
                if(!$additionalInfo){
                    $additionalInfo = __('Earned Reward Points');
                }
				$objectManager = \Magento\Framework\App\ObjectManager::getInstance();
				$balance=$objectManager->create('\Magento\CustomerBalance\Model\Balance');
