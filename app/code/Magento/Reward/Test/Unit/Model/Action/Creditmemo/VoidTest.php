...
{
    /**
     * @var \Magento\Reward\Model\Action\Creditmemo\Voidcredit
     */
    protected $model;

    protected function setUp()
    {
        $this->model = new \Magento\Reward\Model\Action\Creditmemo\Voidcredit();
    }
     ...
     * @covers \Magento\Reward\Model\Action\Creditmemo\Voidcredit::getHistoryMessage
     */
